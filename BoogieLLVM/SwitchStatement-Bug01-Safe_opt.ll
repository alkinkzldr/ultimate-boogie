; #Safe
; ModuleID = 'output_folder/SwitchStatement-Bug01-Safe.ll'
...
@.str.1 = private unnamed_addr constant [33 x i8] c"erw/SwitchStatement-Bug01-Safe.c\00", align 1
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(ptr noundef @.str, ptr noundef @.str.1, i32 noundef 23, ptr noundef @__PRETTY_FUNCTION__.main) #1
  unreachable
