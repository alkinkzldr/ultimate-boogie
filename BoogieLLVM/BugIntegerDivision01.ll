; #Safe
; ModuleID = 'c5/BugIntegerDivision01.c'
source_filename = "c5/BugIntegerDivision01.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

@.str = private unnamed_addr constant [8 x i8] c"a1 == 0\00", align 1
@.str.1 = private unnamed_addr constant [26 x i8] c"c5/BugIntegerDivision01.c\00", align 1
...
entry:
  ...
  store i32 518104, ptr %a1, align 4
  %0 = load i32, ptr %a1, align 4
  %rem = srem i32 %0, 25
  %sub = sub nsw i32 %rem, -13
  %sub1 = sub nsw i32 %sub, 42605
  %div = sdiv i32 %sub1, 5
  %sub2 = sub nsw i32 %div, -8517
  store i32 %sub2, ptr %a1, align 4
