; #Unsafe
; ModuleID = 'c5/ShortCircuit-SideEffect-FunctionCallExpression-Unsafe.c'
...
@.str.1 = private unnamed_addr constant [59 x i8] c"c5/ShortCircuit-SideEffect-FunctionCallExpression-Unsafe.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1

define dso_local i1 @identity(i1 noundef %b) #0 {
entry:
...
lor.end:                                          ; preds = %lor.rhs, %entry
  ...
  %call = call i1 @identity(i1 noundef %2)
  %frombool = zext i1 %call to i8
  store i8 %frombool, ptr %z, align 1
