; #Safe
; ModuleID = 'output_folder/builtin_ssub_overflow.ll'
source_filename = "c5/builtin_ssub_overflow.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

@.str = private unnamed_addr constant [9 x i8] c"overflow\00", align 1
@.str.1 = private unnamed_addr constant [27 x i8] c"c5/builtin_ssub_overflow.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"r == 2\00", align 1

define dso_local i32 @main() {
entry:
  %0 = call { i32, i1 } @llvm.ssub.with.overflow.i32(i32 -2147483647, i32 2147483647)
