; #Unsafe
; ModuleID = 'output_folder/fscanf.ll'
source_filename = "./fscanf.c"
...
@.str.2 = private unnamed_addr constant [11 x i8] c"./fscanf.c\00", align 1
...
entry:
  ...
  %call = call i32 (ptr, ptr, ...) @fscanf(ptr noundef %0, ptr noundef @.str, ptr noundef %x)
...
if.else:                                          ; preds = %entry
  call void @__assert_fail(ptr noundef @.str.1, ptr noundef @.str.2, i32 noundef 59, ptr noundef @__PRETTY_FUNCTION__.main) #2
  unreachable
...
declare i32 @fscanf(ptr noundef, ptr noundef, ...) #0
