; #Safe
; ModuleID = 'output_folder/ShortCircuit-SideEffect-WhileStatement-Safe.ll'
source_filename = "c5/ShortCircuit-SideEffect-WhileStatement-Safe.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

@.str = private unnamed_addr constant [17 x i8] c"x >= 2 && y >= 2\00", align 1
@.str.1 = private unnamed_addr constant [49 x i8] c"c5/ShortCircuit-SideEffect-WhileStatement-Safe.c\00", align 1
...
while.cond:                                       ; preds = %while.end, %entry
  ...
  br i1 %0, label %while.cond3, label %while.end7
...
while.end:                                        ; preds = %while.cond3
  ...
  br i1 %or.cond, label %while.cond, label %if.else, !llvm.loop !8
