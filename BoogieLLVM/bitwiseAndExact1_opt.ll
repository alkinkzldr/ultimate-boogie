; #Safe
; ModuleID = 'output_folder/bitwiseAndExact1.ll'
source_filename = "c5/bitwiseAndExact1.c"
target datalayout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128"
target triple = "aarch64-unknown-linux-gnu"

@.str = private unnamed_addr constant [7 x i8] c"x == y\00", align 1
@.str.1 = private unnamed_addr constant [22 x i8] c"c5/bitwiseAndExact1.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1

define dso_local i32 @main() {
entry:
  %and = and i32 undef, -1
  %cmp = icmp eq i32 %and, undef
